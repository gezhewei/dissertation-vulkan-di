...
namespace glfw {
	...
	public:
		...
		Window(std::initializer_list<std::pair<int, int>> hints, int width = 800, int height = 600);
		...
		void setKeyHandler(KeyCallback cb) {
			_setEventHandler<&Window::_keyCallback>(std::move(cb), glfwSetKeyCallback);
		}
