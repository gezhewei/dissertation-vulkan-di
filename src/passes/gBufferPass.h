...
public:
	...
	[[nodiscard]] vk::Image getEmissionBuffer() const {
		return _emissionBuffer.get();
	}
	...
	[[nodiscard]] vk::ImageView getEmissionView() const {
		return _emissionView.get();
	}
...
private:
	...
	vma::UniqueImage _emissionBuffer;
	...
	vk::UniqueImageView _emissionView;
